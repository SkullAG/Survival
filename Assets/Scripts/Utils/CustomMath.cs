...
public static class CustomMath
{
	...
	public static Vector3 CalculateVelocity(Vector3 currentVelocity, Vector3 direction, float acceleration, float deceleration = 0, float limitVelocity = Mathf.Infinity, float friction = 1f)
	{
	...
	///	<param name="limitVelocity">The maximum velocity or the desired velocity, default is infinity</param>
	///	<param name="deceleration">If 0 acceleration will be used instead</param>
	public static Vector2 CalculateVelocity(Vector2 currentVelocity, Vector2 direction, float acceleration, float limitVelocity = Mathf.Infinity, float friction = 1f)
	{
		Vector3 limVel = direction * limitVelocity;
